import{j as n}from"./jsx-runtime-BjG_zV1W.js";import{r as u}from"./index-DGOumNSj.js";import{B as c}from"./button.esm-VjJyv5J4.js";import{S as d}from"./Spinner-vRPLJ-m1.js";import{c as y}from"./classnames-CPOy7I0U.js";const i=l=>{const{children:t,className:s="",prefixCls:o="button",active:m=!1,severity:a="primary",size:r="large",...p}=l,e=y(o);return n.jsx(c,{...p,severity:a,loadingIcon:n.jsx(d,{strokeWidth:"5",className:e("loading-icon",[e(`loading-icon-${a}`),e(`loading-icon-${r}`)].join(" "))}),className:e(void 0,[e(a),e(r),m?e(`${a}-active`):"",s].join(" ")),children:t})};u.memo(i);i.__docgenInfo={description:"",methods:[],displayName:"Button",props:{prefixCls:{required:!1,tsType:{name:"string"},description:""},active:{required:!1,tsType:{name:"boolean"},description:""},size:{required:!1,tsType:{name:"union",raw:"'small' | 'medium' | 'large'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'medium'"},{name:"literal",value:"'large'"}]},description:""},severity:{required:!1,tsType:{name:"union",raw:`| PrimeButtonProps['severity']
| 'primary'
| 'secondary'
| 'grey'
| 'black'
