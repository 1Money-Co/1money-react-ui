import{r as o}from"./index-RYns6xqu.js";import{C as x,u as E,P as S,h as _,g as m}from"./componentbase.esm-BUIfdjtz.js";function c(){return c=Object.assign?Object.assign.bind():function(n){for(var e=1;e<arguments.length;e++){var r=arguments[e];for(var a in r)Object.prototype.hasOwnProperty.call(r,a)&&(n[a]=r[a])}return n},c.apply(this,arguments)}function u(n){"@babel/helpers - typeof";return u=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},u(n)}function N(n,e){if(u(n)!=="object"||n===null)return n;var r=n[Symbol.toPrimitive];if(r!==void 0){var a=r.call(n,e||"default");if(u(a)!=="object")return a;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(n)}function k(n){var e=N(n,"string");return u(e)==="symbol"?e:String(e)}function B(n,e,r){return e=k(e),e in n?Object.defineProperty(n,e,{value:r,enumerable:!0,configurable:!0,writable:!0}):n[e]=r,n}var C={root:function(e){var r=e.props;return r.mode==="indeterminate"?m("p-progressbar p-component p-progressbar-indeterminate"):m("p-progressbar p-component p-progressbar-determinate")},value:"p-progressbar-value p-progressbar-value-animate",label:"p-progressbar-label",container:"p-progressbar-indeterminate-container"},D=`
@layer primereact {
  .p-progressbar {
      position: relative;
      overflow: hidden;
