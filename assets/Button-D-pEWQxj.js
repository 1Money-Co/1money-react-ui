import{j as r}from"./jsx-runtime-BjG_zV1W.js";import{r as c}from"./index-CP2yOfOm.js";import{B as p}from"./button.esm-HBeH8jE_.js";import{S as d}from"./Spinner-BctWPXJz.js";import{c as y}from"./classnames-lRq3rz0l.js";const i=t=>{const{children:l,className:s="",prefixCls:o="button",active:m=!1,severity:a="primary",size:n="large",...u}=t,e=y(o);return r.jsx(p,{...u,severity:a,loadingIcon:r.jsx(d,{strokeWidth:"5",className:e("loading-icon",[e(`loading-icon-${a}`),e(`loading-icon-${n}`)].join(" "))}),className:e(void 0,[e(a),e(n),m?e(`${a}-active`):"",s].join(" ")),children:l})};c.memo(i);i.__docgenInfo={description:"",methods:[],displayName:"Button",props:{ref:{required:!1,tsType:{name:"RefObject",elements:[{name:"HTMLButtonElement"}],raw:"RefObject<HTMLButtonElement>"},description:""},prefixCls:{required:!1,tsType:{name:"string"},description:""},active:{required:!1,tsType:{name:"boolean"},description:""},size:{required:!1,tsType:{name:"union",raw:"'small' | 'medium' | 'large'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'medium'"},{name:"literal",value:"'large'"}]},description:""},severity:{required:!1,tsType:{name:"union",raw:`| PrimeButtonProps['severity']
| 'primary'
| 'secondary'
| 'grey'
| 'black'
