...
`),N={cProps:void 0,cParams:void 0,cName:void 0,defaultProps:{pt:void 0,ptOptions:void 0,unstyled:!1},context:{},globalCSS:void 0,classes:{},styles:"",extend:function(){var n=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},e=n.css,t=R(R({},n.defaultProps),N.defaultProps),a={},i=function(f){var d=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return N.context=d,N.cProps=f,T.getMergedProps(f,t)},o=function(f){return T.getDiffProps(f,t)},u=function(){var f,d=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},p=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"",c=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},E=arguments.length>3&&arguments[3]!==void 0?arguments[3]:!0;d.hasOwnProperty("pt")&&d.pt!==void 0&&(d=d.pt);var b=p,x=/./g.test(b)&&!!c[b.split(".")[0]],y=x?T.toFlatCase(b.split(".")[1]):T.toFlatCase(b),w=c.hostName&&T.toFlatCase(c.hostName),h=w||c.props&&c.props.__TYPE&&T.toFlatCase(c.props.__TYPE)||"",A=y==="transition",k="data-pc-",D=function(O){return O!=null&&O.props?O.hostName?O.props.__TYPE===O.hostName?O.props:D(O.parent):O.parent:void 0},B=function(O){var Q,te;return((Q=c.props)===null||Q===void 0?void 0:Q[O])||((te=D(c))===null||te===void 0?void 0:te[O])};N.cParams=c,N.cName=h;var W=B("ptOptions")||N.context.ptOptions||{},H=W.mergeSections,q=H===void 0?!0:H,U=W.mergeProps,z=U===void 0?!1:U,$=function(){var O=X.apply(void 0,arguments);return Array.isArray(O)?{className:ye.apply(void 0,je(O))}:T.isString(O)?{className:O}:O!=null&&O.hasOwnProperty("className")&&Array.isArray(O.className)?{className:ye.apply(void 0,je(O.className))}:O},K=E?x?ze($,b,c):Ye($,b,c):void 0,I=x?void 0:pe(de(d,h),$,b,c),Y=!A&&R(R({},y==="root"&&Se({},"".concat(k,"name"),c.props&&c.props.__parentMetadata?T.toFlatCase(c.props.__TYPE):h)),{},Se({},"".concat(k,"section"),y));return q||!q&&I?z?ce([K,I,Object.keys(Y).length?Y:{}],{classNameMergeFunction:(f=N.context.ptOptions)===null||f===void 0?void 0:f.classNameMergeFunction}):R(R(R({},K),I),Object.keys(Y).length?Y:{}):R(R({},I),Object.keys(Y).length?Y:{})},s=function(){var f=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},d=f.props,p=f.state,c=function(){var h=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"",A=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return u((d||{}).pt,h,R(R({},f),A))},E=function(){var h=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},A=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"",k=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{};return u(h,A,k,!1)},b=function(){return N.context.unstyled||ie.unstyled||d.unstyled},x=function(){var h=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"",A=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return b()?void 0:X(e&&e.classes,h,R({props:d,state:p},A))},y=function(){var h=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"",A=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},k=arguments.length>2&&arguments[2]!==void 0?arguments[2]:!0;if(k){var D,B=X(e&&e.inlineStyles,h,R({props:d,state:p},A)),W=X(a,h,R({props:d,state:p},A));return ce([W,B],{classNameMergeFunction:(D=N.context.ptOptions)===null||D===void 0?void 0:D.classNameMergeFunction})}};return{ptm:c,ptmo:E,sx:y,cx:x,isUnstyled:b}};return R(R({getProps:i,getOtherProps:o,setMetaData:s},n),{},{defaultProps:t})}},X=function(n){var e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"",t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},a=String(T.toFlatCase(e)).split("."),i=a.shift(),o=T.isNotEmpty(n)?Object.keys(n).find(function(u){return T.toFlatCase(u)===i}):"";return i?T.isObject(n)?X(T.getItemValue(n[o],t),a.join("."),t):void 0:T.getItemValue(n,t)},de=function(n){var e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"",t=arguments.length>2?arguments[2]:void 0,a=n==null?void 0:n._usept,i=function(u){var s,l=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!1,f=t?t(u):u,d=T.toFlatCase(e);return(s=l?d!==N.cName?f==null?void 0:f[d]:void 0:f==null?void 0:f[d])!==null&&s!==void 0?s:f};return T.isNotEmpty(a)?{_usept:a,originalValue:i(n.originalValue),value:i(n.value)}:i(n,!0)},pe=function(n,e,t,a){var i=function(b){return e(b,t,a)};if(n!=null&&n.hasOwnProperty("_usept")){var o=n._usept||N.context.ptOptions||{},u=o.mergeSections,s=u===void 0?!0:u,l=o.mergeProps,f=l===void 0?!1:l,d=o.classNameMergeFunction,p=i(n.originalValue),c=i(n.value);return p===void 0&&c===void 0?void 0:T.isString(c)?c:T.isString(p)?p:s||!s&&c?f?ce([p,c],{classNameMergeFunction:d}):R(R({},p),c):c}return i(n)},Wt=function(){return de(N.context.pt||ie.pt,void 0,function(n){return T.getItemValue(n,N.cParams)})},Ht=function(){return de(N.context.pt||ie.pt,void 0,function(n){return X(n,N.cName,N.cParams)||T.getItemValue(n,N.cParams)})},ze=function(n,e,t){return pe(Wt(),n,e,t)},Ye=function(n,e,t){return pe(Ht(),n,e,t)},nn=function(n){var e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:function(){},t=arguments.length>2?arguments[2]:void 0,a=t.name,i=t.styled,o=i===void 0?!1:i,u=t.hostName,s=u===void 0?"":u,l=ze(X,"global.css",N.cParams),f=T.toFlatCase(a),d=ue(Ft,{name:"base",manual:!0}),p=d.load,c=ue(jt,{name:"common",manual:!0}),E=c.load,b=ue(l,{name:"global",manual:!0}),x=b.load,y=ue(n,{name:a,manual:!0}),w=y.load,h=function(k){if(!s){var D=pe(de((N.cProps||{}).pt,f),X,"hooks.".concat(k)),B=Ye(X,"hooks.".concat(k));D==null||D(),B==null||B()}};h("useMountEffect"),qe(function(){p(),x(),e()||(E(),o||w())}),Pt(function(){h("useUpdateEffect")}),ee(function(){h("useUnmountEffect")})};export{N as C,_ as D,Xt as E,qt as F,Ut as I,T as O,Ce as P,Be as U,ft as Z,nn as a,Zt as b,Jt as c,en as d,Pt as e,ee as f,ye as g,ie as h,ue as i,qe as j,Tt as k,zt as l,Ct as m,Vt as n,fe as o,be as p,tn as q,Yt as r,Kt as s,Ve as t,Qt as u,Gt as v};
