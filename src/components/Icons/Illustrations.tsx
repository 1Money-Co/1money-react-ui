...
export const IllusLocked: FC<IconWrapperProps & IllustrationsCustomProps> = ({ borderColor = '#1D1D1F', ...rest }) => <IconWrapper viewBox="0 0 74 74" {...rest}>
  ...
  <mask id="path-2-inside-1_85_13893" fill="white">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M39 11C33.4772 11 29 15.4772 29 21V28H49V21C49 15.4772 44.5229 11 39 11ZM57 28V21C57 11.0589 48.9411 3 39 3C29.0589 3 21 11.0589 21 21V28H13C11.8954 28 11 28.8954 11 30V64C11 65.1046 11.8954 66 13 66H15H63H65C66.1046 66 67 65.1046 67 64V30C67 28.8954 66.1046 28 65 28H57Z" />
  </mask>
  ...
  <circle cx="14" cy="58" r="12" stroke={borderColor} stroke-width="2" />
  <path fill-rule="evenodd" clip-rule="evenodd" d="M12.5842 57.9986L8.34164 62.2411L9.75585 63.6553L13.9984 59.4128L18.2425 63.6569L19.6568 62.2427L15.4126 57.9986L19.6553 53.7558L18.2411 52.3416L13.9984 56.5844L9.75726 52.3432L8.34305 53.7574L12.5842 57.9986Z" fill="white" />
  <defs>
...
export const IllusError: FC<IconWrapperProps & IllustrationsCustomProps> = ({ borderColor = '#1D1D1F', ...rest }) => <IconWrapper viewBox="0 0 74 74" {...rest}>
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M16.2308 53L7.84256 41.3164C6.76234 39.8118 6.85635 37.7624 8.06979 36.3631L33.9779 6.48512C35.5729 4.64582 38.4271 4.64582 40.0221 6.48512L65.9302 36.3631C67.1436 37.7624 67.2377 39.8118 66.1574 41.3164L57.7692 53H58C60.2091 53 62 54.7909 62 57V61C62 63.2091 60.2091 65 58 65H16C13.7909 65 12 63.2091 12 61V57C12 54.7909 13.7909 53 16 53H16.2308ZM37 6.05282L65.4541 38.8668L55.3072 53H18.6928L8.54593 38.8668L37 6.05282ZM60 55V63H14V55H60Z" fill={borderColor} />
</IconWrapper>;
...
export const IllusChecked: FC<IconWrapperProps & IllustrationsCustomProps> = ({ borderColor = '#1D1D1F', ...rest }) => <IconWrapper viewBox="0 0 54 62" {...rest}>
  <path fill-rule="evenodd" clip-rule="evenodd" d="M17 60H16.5V62H17H21H25H29H33H37H37.5V60H37H33H29H25H21H17Z" fill={borderColor} />
  <circle cx="27" cy="27" r="27" fill="white" />
  <circle cx="27" cy="27" r="26" stroke={borderColor} stroke-width="2" fill="transparent" />
  ...
  <path d="M16 26.3462L24 34.5L37.5 20" stroke={borderColor} stroke-width="2" fill="transparent" />
  <defs>
